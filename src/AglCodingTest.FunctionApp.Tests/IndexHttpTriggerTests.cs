...
using AGLCodeTest.FunctionApp.Tests.Fixtures;
...
namespace AGLCodeTest.FunctionApp.Tests
{
    /// <summary>
    ...
    public class IndexHttpTriggerTests : IClassFixture<FunctionAppFixture>
    {
        ...
        public async void Given_Factory_Run_ShouldReturn_Result()
        {
            ...
            var factory = this._fixture.ArrangeFunctionFactory(out Mock<IAGLCodeTestHttpTriggerFunction> function);
